          ...
          <div className="field">
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <div className="relative">
                ...
                />
                <div className="w-5 h-5 rounded border-2 border-line bg-white peer-checked:bg-brand peer-checked:border-brand transition-colors flex items-center justify-center">
                  {isUrgent && (
              ...
              <span className="text-sm font-semibold">Mark as urgent</span>
            </label>
          </div>
